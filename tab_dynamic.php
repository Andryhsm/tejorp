	...
	function print_data($data, $plus = ""){
		...
		foreach ($data as $key => $value) {
			...
			if(($val = intval($k)) > $limit){
				if($val == $deb){
					  echo  "<tr>
	                            <td><input type='text' readonly class='form-control datetimepickery' name='Horaire".$plus."".$inc_h."' id='Horaire".$plus."".$inc_h."'></td>
	                            ...
	                            <td><input type='text' readonly class='form-control datetimepickery' name='Horaire".$plus."".($inc_h + 2)."' id='Horaire".$plus."".($inc_h + 2)."'></td>
	                            ...
	                            <td><input type='text' readonly class='form-control datetimepickery' name='Horaire".$plus."".($inc_h + 4)."' id='Horaire".$plus."".($inc_h + 4)."'></td>
	                            ...
	                            <td><input type='text' readonly class='form-control datetimepickery' name='Horaire".$plus."".($inc_h + 6)."' id='Horaire".$plus."".($inc_h + 6)."'></td>
