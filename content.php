 ...
 */
	...
	foreach (array_keys($_POST) as $value) {
		eval("\$".$value." = (isset(\$_POST[\"".$value."\"])) ? htmlentities(addslashes(\$_POST[\"".$value."\"]), ENT_NOQUOTES,'ISO-8859-1', true) : \"\";");
	}
	for($i = 5; $i < 85; $i++){
		eval("\$Horaire".$i." = (isset(\$_POST[\"Horaire".$i."\"])) ? htmlentities(addslashes(\$_POST[\"Horaire".$i."\"]), ENT_NOQUOTES,'ISO-8859-1', true) : \"\";");
	}
	for($i = 5; $i < 85; $i++){
		eval("\$Horaire_".$i." = (isset(\$_POST[\"Horaire_".$i."\"])) ? htmlentities(addslashes(\$_POST[\"Horaire_".$i."\"]), ENT_NOQUOTES,'ISO-8859-1', true) : \"\";");
	}
	for($i = 5; $i < 45; $i++){
		eval("\$Debit".$i." = (isset(\$_POST[\"Debit".$i."\"])) ? htmlentities(addslashes(\$_POST[\"Debit".$i."\"]), ENT_NOQUOTES,'ISO-8859-1', true) : \"\";");
	}
	for($i = 5; $i < 45; $i++){
		eval("\$Debit_".$i." = (isset(\$_POST[\"Debit_".$i."\"])) ? htmlentities(addslashes(\$_POST[\"Debit_".$i."\"]), ENT_NOQUOTES,'ISO-8859-1', true) : \"\";");
	}
