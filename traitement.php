...
$idPatient = $_POST['nompatient']."-".$_POST['prenompatient'];

try {

    $bdd->exec("INSERT INTO infobastide(nomresp, prenomresp, mobileresp, coordonnee, idPrescripteur, idPatient) VALUES('" . $_POST["nomresp"] . "','" . $_POST["prenomresp"] . "','" . $_POST["mobileresp"] . "','" . $_POST["coordonnee"] . "', '" .$idPrescripteur."', '" .$idPatient."')") or die(print_r($bdd->ErrorInfo()));
    ...
    $bdd->exec("INSERT INTO choixmateriel(pompe, dateinstallation, typecatheter, modele, longueurcanule, longueurtubulure, typecatheter2, modele2, longueurcanule2, longueurtubulure2, inserteur, reservoir, spp, observation, idPrescripteur, idPatient) VALUES('" . $_POST["Pompe"] . "','" . $_POST["dateinstallation"] . "','" . $_POST["catheter"] . "','" . $_POST["modele"] . "','" . $_POST["longueurcanule"] . "','" . $_POST["longueurtubulure"] . "','" . $_POST["catheter2"] . "','" . $_POST["modele2"] . "','" . $_POST["longueurcanule2"] . "','" . $_POST["longueurtubulure2"] . "','" . $_POST["inserteur"] . "','" . utf8_decode($_POST["reservoir"]) . "','" . $_POST["spp"] . "','" . $_POST["observatiom"] . "', '" .$idPrescripteur."', '" .$idPatient."')")or die(print_r($bdd->ErrorInfo()));
