...
$environnement = (htmlentities(addslashes($_POST["details"]), ENT_NOQUOTES,'UTF-8', true));
...
try {
    ...
    $bdd->exec("INSERT INTO infopatient(nompatient, prenompatient, datenaissance, agepatient, telpatient, mobilepatient, adressepatient, codepostalpatient, villepatient) VALUES('" . htmlentities(addslashes($_POST["nompatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["prenompatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["datenaissance"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["agepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["telpatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobilepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["adressepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["codepostalpatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villepatient"]), ENT_NOQUOTES,'UTF-8', true) . "')")or die(print_r($bdd->ErrorInfo()));

    $bdd->exec("INSERT INTO infoprescripteur(etablissementprescripteur, serviceep, diabetologueprescripteur, teldp, mobiledp, villedp, maildp, diabetologueliberal, teldl, mobiledl, villedl, maildl, medecintraitant, telmt, mobilemt, villemt, mailmt,dieteticienne, teld, mobiled, villed, maild, membrereseau, nomreseau) VALUES ('" . htmlentities(addslashes($_POST["etablissementprescripteur"]), ENT_NOQUOTES,'UTF-8', true) . "', '" . htmlentities(addslashes($_POST["serviceep"]), ENT_NOQUOTES,'UTF-8', true) . "', '" . htmlentities(addslashes($_POST["diabetologueprescripteur"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["teldp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobiledp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villedp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["maildp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["diabetologueliberal"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["teldl"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobiledl"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villedl"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["maildl"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["medecintraitant"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["telmt"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobilemt"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villemt"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mailmt"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["dieteticienne"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["teld"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobiled"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villed"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["maild"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["membrereseau"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["nomreseau"]), ENT_NOQUOTES,'UTF-8', true) . "')") or die(print_r($bdd->errorInfo()));


    $bdd->exec("INSERT INTO choixmateriel(pompe, dateinstallation, typecatheter, modele, longueurcanule, longueurtubulure, typecatheter2, modele2, longueurcanule2, longueurtubulure2, inserteur, reservoir, spp, observation, idPrescripteur, idPatient) VALUES('" . htmlentities(addslashes($_POST["Pompe"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["dateinstallation"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["catheter"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["modele"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurcanule"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurtubulure"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["catheter2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["modele2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurcanule2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurtubulure2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["inserteur"]), ENT_NOQUOTES,'UTF-8', true) . "','" . utf8_decode(htmlentities(addslashes($_POST["reservoir"]), ENT_NOQUOTES,'UTF-8', true)) . "','" . htmlentities(addslashes($_POST["spp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["observatiom"]), ENT_NOQUOTES,'UTF-8', true) . "', '".$idPrescripteur."', '".$idPatient."')")or die(print_r($bdd->ErrorInfo()));
