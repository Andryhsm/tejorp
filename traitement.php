...
try {
    ...
    $bdd->exec("INSERT INTO infopatient(nompatient, prenompatient, datenaissance, agepatient, telpatient, mobilepatient, adressepatient, codepostalpatient, villepatient, idPrescripteur) VALUES('" . htmlentities(addslashes($_POST["nompatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["prenompatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["datenaissance"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["agepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["telpatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobilepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["adressepatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["codepostalpatient"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["villepatient"]), ENT_NOQUOTES,'UTF-8', true) . "', '".$idPrescripteur."')")or die(print_r($bdd->ErrorInfo()));
