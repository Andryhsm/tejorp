...
try {
    ...
    $bdd->exec("INSERT INTO infobastide(nomresp, prenomresp, mobileresp, coordonnee) VALUES('" . htmlentities(addslashes($_POST["nomresp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["prenomresp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["mobileresp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["coordonnee"]), ENT_NOQUOTES,'UTF-8', true) . "')") or die(print_r($bdd->ErrorInfo()));
    ...
    $bdd->exec("INSERT INTO choixmateriel(pompe, dateinstallation, typecatheter, modele, longueurcanule, longueurtubulure, typecatheter2, modele2, longueurcanule2, longueurtubulure2, inserteur, reservoir, spp, observation) VALUES('" . htmlentities(addslashes($_POST["Pompe"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["dateinstallation"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["catheter"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["modele"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurcanule"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurtubulure"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["catheter2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["modele2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurcanule2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["longueurtubulure2"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["inserteur"]), ENT_NOQUOTES,'UTF-8', true) . "','" . utf8_decode(htmlentities(addslashes($_POST["reservoir"]), ENT_NOQUOTES,'UTF-8', true)) . "','" . htmlentities(addslashes($_POST["spp"]), ENT_NOQUOTES,'UTF-8', true) . "','" . htmlentities(addslashes($_POST["observatiom"]), ENT_NOQUOTES,'UTF-8', true) . "')")or die(print_r($bdd->ErrorInfo()));
    ...
    $bdd->exec("INSERT INTO manipulationdelaPompe
		...
		VALUES ('"
                    ...
                    . htmlentities(addslashes($_POST["pmpautre"]), ENT_NOQUOTES,'UTF-8', true) . "')") or die(print_r($bdd->ErrorInfo()));
    ...
    $bdd->exec("INSERT INTO alarmesetprecautions
		...
		VALUES ('"
                    ...
                    . htmlentities(addslashes($_POST["alarmeautre"]), ENT_NOQUOTES,'UTF-8', true) . "')") or die(print_r($bdd->ErrorInfo()));
