                ...
                <table class="table table-bordered table-responsive" style="color: white;">
                    ...
                    <tbody id="contentBasal1">
                        <tr>
                            ...
                            <td><input type="text" readonly class="form-control datetimepickery" name="Horaire1" id="Horaire1"></td>
                            <td><input type="number" class="form-control" name="Debit1" id="Debit1"></td>
                            <td><input type="text" class="form-control" value="00:00" readonly></td>
                            <td><input type="text" readonly class="form-control datetimepickery" name="Horaire2" id="Horaire2"></td>
                            <td><input type="number" class="form-control" name="Debit2" id="Debit2"></td>
                            <td><input type="text" class="form-control" value="00:00" readonly></td>
                            <td><input type="text" readonly class="form-control datetimepickery" name="Horaire3" id="Horaire3"></td>
                            <td><input type="number" class="form-control" name="Debit3" id="Debit3"></td>
                            <td><input type="text" class="form-control" value="00:00" readonly></td>
                            <td><input type="text" readonly class="form-control datetimepickery" name="Horaire4" id="Horaire4"></td>
